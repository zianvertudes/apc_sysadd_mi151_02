...
-- Table `tms`.`guest`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tms`.`guest` (
...
CREATE TABLE IF NOT EXISTS `tms`.`employee` (
  ...
  CONSTRAINT `fk_employee_department1`
    FOREIGN KEY (`dept_id`)
    REFERENCES `tms`.`department` (`dept_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `tms`.`ticket` (
  ...
  CONSTRAINT `fk_ticket_guest`
    ...
    REFERENCES `tms`.`guest` (`guest_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ticket_room1`
    FOREIGN KEY (`room_id`)
    REFERENCES `tms`.`room` (`room_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ticket_employee1`
    FOREIGN KEY (`emp_create_id`)
    REFERENCES `tms`.`employee` (`emp_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tms`.`ticket_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tms`.`ticket_details` (
  ...
  CONSTRAINT `fk_ticket_details_category1`
    ...
    REFERENCES `tms`.`category` (`category_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ticket_details_ticket1`
    FOREIGN KEY (`ticket_id`)
    REFERENCES `tms`.`ticket` (`ticket_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
